---
title: "General settings testing auto commit when does this work"
...
Navigate to **Settings → General** to access these options.asdfasdfasdfasdf

## Generaldfdfdfdfdffff

| Setting | Description |
| --- | --- |
| **Workspace name** | The display name used in the UI, emaidfdfdfdfl notifications, and shared links. |
